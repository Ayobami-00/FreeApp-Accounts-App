...
import 'package:freeapp_accounts_app/db/debitUpload.dart';
...
class _AddDebitState extends State<AddDebit> {
  DebitUpload _DebitUpload = DebitUpload();
                      ...
                      child: Form(
                          ...
                          child: ListView(
                            children: <Widget>[
                              ...
                              Text(
                                "Add two team members below relevant to this Debit",
